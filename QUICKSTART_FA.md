...
* اگر می‌خواهی بدانی همه‌چیز سالم است: `python manage.py test` (۷۲ تست) و در پوشه‌ی فرانت‌اند
  `npx tsc -b && npx oxlint src && npm run build && npm run test:ui` (۴۷ بررسی رابط کاربری)
