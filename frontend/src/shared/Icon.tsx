...
/** قلب + بی‌نهایت بدون قاب — همان مسیر فاوآیکون/بوت، برای استفاده در رابط */
export function HeartInfinity({
  size = 64,
  className = '',
  strokeWidth = 3.2,
}: {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" className={className} aria-hidden="true">
      <defs>
        <linearGradient id="loveos-hi-g" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#ff9ecb" />
          <stop offset="55%" stopColor="#f767a8" />
          <stop offset="100%" stopColor="#bba0fb" />
        </linearGradient>
